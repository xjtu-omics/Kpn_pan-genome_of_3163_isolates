...
if __name__=='__main__':
    ...
    folder_path="/data/home/sfwang/kpn/Panaroo/both-align-results-strict-adv/feature_matrix/"
    ...
    bigFM.to_csv('/data/home/sfwang/kpn/Panaroo-DownStream-both/final_core_feature_matrix.csv')